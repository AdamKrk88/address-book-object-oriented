...
void AdresatMenedzer :: wyszukajAdresatowPoImieniuDlaZalogowanegoUzytkownika() {
...
void AdresatMenedzer :: wyszukajAdresatowPoNazwiskuDlaZalogowanegoUzytkownika() {
...
void AdresatMenedzer :: edytujAdresata() {
    ...
    for (int i = 0; i < adresaci.size(); i++) {
        if (adresaci[i].pobierzId() == idEdytowanegoAdresata) {
            ...
            switch (menu.wybierzOpcjeZMenuEdycjaAdresata()) {
            case '1':
